...
const LevelBadge: FC<LevelBadgeProps> = ({ level }) => {
  ...
  return (
    <div
      className={cx(
        "okd-rounded-sm okd-relative okd-w-min okd-h-5 okd-flex okd-items-center okd-select-none",
        {
    ...
    >
      <div className="okd-h-full okd-w-5 okd-bg-white okd-absolute okd-top-0 okd--left-3" />
      <Icon
        name={badgeIconName}
        width={20}
        height={20}
        className="okd-relative"
      />
      <p
