...
import { Typography, Text, Link, Heading, Paragraph, Address } from '../components/Typography';
...
export const AddressDemo = () => {
  const address = '0xF33334061FcD161FEDbd1Bc3BB682d5AD3Ca6949'
  return (
    <div className="okd-bg-gray-50 okd-p-4">
      <ConfigBar />
      <Divider />
      <Heading>Simple Usage</Heading>
      <Address address={address} />
      <Divider />

      <Heading>Passing text instead of an address</Heading>
      <Address address={'ballabalablablablaba'} />
      <Divider />
      <Divider />

      <Heading level={1}>Address in DAPP be look like</Heading>
      <div
        className="okd-relative okd-max-w-max okd-p-2 okd-flex okd-items-center okd-space-x-3 okd-hover:border-gray-400 okd-focus-within:ring-2 okd-focus-within:ring-offset-2 okd-focus-within:ring-brand-500"
      >
        <div className="okd-flex-shrink-0">
          <img className="okd-h-8 okd-w-8 okd-rounded-full" src="https://onekey-asset.com/assets/btc/btc.png" alt="BTC Icon" />
        </div>
        <div className="okd-flex-1 okd-min-w-0">
          <Paragraph size="md">BTC <Text size="md" color="gray">USDT</Text></Paragraph>
          <Address>{address}</Address>
        </div>
      </div>
      <Divider />

      <Heading>Using `address` property</Heading>
      <div
        className="okd-relative okd-max-w-max okd-p-2 okd-flex okd-items-center okd-space-x-3 okd-hover:border-gray-400 okd-focus-within:ring-2 okd-focus-within:ring-offset-2 okd-focus-within:ring-brand-500"
      >
        <div className="okd-flex-shrink-0">
          <img className="okd-h-8 okd-w-8 okd-rounded-full" src="https://onekey-asset.com/assets/btc/btc_gray.png" alt="BTC Gray Icon" />
        </div>
        <div className="okd-flex-1 okd-min-w-0">
          <Paragraph size="md">BTC Gray <Text size="md" color="gray">USDT</Text></Paragraph>
          <Address address={address} />
        </div>
      </div>
      <Divider />

      <Heading>With `short` property</Heading>
      <div
        className="okd-relative okd-max-w-max okd-p-2 okd-flex okd-items-center okd-space-x-3 okd-hover:border-gray-400 okd-focus-within:ring-2 okd-focus-within:ring-offset-2 okd-focus-within:ring-brand-500"
      >
        <div className="okd-flex-shrink-0">
          <img className="okd-h-8 okd-w-8 okd-rounded-full" src="https://onekey-asset.com/assets/polygon/polygon.png" alt="POLYGON Icon" />
        </div>
        <div className="okd-flex-1 okd-min-w-0">
          <Paragraph size="md">polygon <Text size="md" color="gray">USDT</Text></Paragraph>
          <Address short>{address}</Address>
        </div>
      </div>
      <Divider />

      <Heading>Custom your address</Heading>
      <div
        className="okd-relative okd-max-w-max okd-p-2 okd-flex okd-items-center okd-space-x-3 okd-hover:border-gray-400 okd-focus-within:ring-2 okd-focus-within:ring-offset-2 okd-focus-within:ring-brand-500"
      >
        <div className="okd-flex-shrink-0">
          <img className="okd-h-8 okd-w-8 okd-rounded-full" src="https://onekey-asset.com/assets/sol/sol.png" alt="Solana Icon" />
        </div>
        <div className="okd-flex-1 okd-min-w-0">
          <Paragraph size="md">Sol <Text size="md" color="gray">USDT</Text></Paragraph>
          <Address address={shortenAddress(address, 12)} />
        </div>
      </div>
    </div>
  )
